...
##robots coordinates that represents refernce to the video frame origin/edges
X1 = 182
Y1 = -93.4
ke = 0
while(1):
	...
	for c in cnts:
		...
		if area > 6000:
			...
			X = X1 + (cY * 0.3125) # this step is the mapping part.  viewers can create their own mapping solution based on the mapping word document in this project
			Y = Y1 + (cX * 0.3125)
